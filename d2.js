...
let n2 = 20
if (n1 > n2) {
  console.log("ecco il maggiore", n1)
} else {
  console.log("questo è il maggiore", n2)
}
...
if (totalShoppingCart2 > 50) {
  ...
  console.log(totale2 + spedizione2)
}
/* ESERCIZIO 7
...
} else console.log("un altro tipo")
/* ESERCIZIO 9
